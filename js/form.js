...
adicionarB.addEventListener("click", function (event) {
  ...
  var form = document.querySelector("#form-adiciona"); //Extrai as informações do paciente do formulário
  var paciente = obtemPacienteDoFormulario(form);

  //Monta a Tr com os dados de obtemPacienteDoFormulario e inclui em pacienteTr
